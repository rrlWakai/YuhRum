...
const occasions = [
  {
    icon: Sparkles,
    title: "Birthdays",
    desc: "Celebrate with your whole barkada in a space that is entirely yours.",
  },
  {
    icon: Users,
    title: "Family Gatherings",
    desc: "Reunions, holidays, and real quality time — no strangers around.",
  },
  {
    icon: Waves,
    title: "Barkada Trips",
    desc: "The ultimate group getaway — swim, eat, chill, repeat.",
  },
  {
    icon: ConciergeBell,
    title: "Team Building",
    desc: "Productive and fun, away from the office environment.",
  },
];
...
const testimonials = [
  {
    quote:
      "Best family trip we have had in years. The whole place was ours — no strangers, just pure quality time.",
    guest: "The Reyes Family",
    role: "Family of 8, Laguna",
  },
  {
    quote:
      "Booked Villa Serena for our friend's birthday and it was perfect. Pool, space, vibe — all 10/10.",
    guest: "Marga S.",
    role: "Barkada Group, Manila",
  },
  {
    quote:
      "Our team building at Villa Verde was a total hit. Private, comfortable, and truly memorable.",
    guest: "Carlo T.",
    ...
    <main className="relative bg-[#F7F6F4] text-neutral-900">
      ...
      <section className="relative min-h-100vh overflow-hidden border-b border-gray-200">
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-linear-to-b from-black/55 via-black/25 to-black/60 will-change-transform"
        />
        <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-1240px flex-col px-6 pb-10 pt-32 sm:pt-40 md:pt-52 md:px-10 md:pb-12">
          ...
          >
            ...
            >
              Book the entire property for your family, barkada, or private
              event. No shared spaces. No strangers. Just yours.
            </motion.p>
            <motion.div
        ...
        <div className="mx-auto grid max-w-1240px items-start gap-14 lg:grid-cols-[1.1fr_0.9fr]">
          <Reveal delay={0.05} className="relative">
            ...
            >
              ...
              <p className="mt-3 font-serif text-2xl text-neutral-900">
                The entire villa is yours alone.
              </p>
            </motion.div>
          </Reveal>
          <Reveal delay={0.18} className="pt-2 sm:pt-6 lg:pt-20">
            ...
            <p className="mt-8 max-w-xl text-base leading-relaxed text-gray-700 md:text-lg">
              When you book, you get the whole place — not just a room. No other
              guests, no shared spaces. Just you, your family, or your group
              enjoying a completely private villa from check-in to check-out.
            </p>
        ...
        <div className="mx-auto max-w-1240px px-6 md:px-10">
          <Reveal delay={0.05} className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/85 md:text-lg">
              Both properties are 100% private. Swipe to explore each villa and
              find the one that fits your group.
            </p>
          </Reveal>
        </div>
        <div className="mt-14">
          <RoomCarousel
            rooms={villaCards}
            onSelect={(i) =>
              onNavigate({ type: "detail", villaId: villas[i].id })
            }
          />
        </div>
      </ParallaxSection>
        ...
        <div className="mx-auto grid max-w-1240px items-start gap-14 lg:grid-cols-[0.9fr_1.1fr]">
          <Reveal delay={0.06} className="lg:sticky lg:top-28">
            ...
            <p className="mt-6 max-w-md text-base leading-relaxed text-gray-700">
              Both villas come fully set up — so you can focus on enjoying your
              time, not worrying about what is missing.
            </p>
          </Reveal>
          <motion.div
            initial="hidden"
      ...
      <Section id="gallery" className="border-t border-gray-200 bg-[#F7F6F4]">
        <div className="mx-auto max-w-1240px">
          ...
          <div className="mt-8 text-center">
            <button
              onClick={() =>
                onNavigate({ type: "gallery", villaId: villas[0].id })
              }
          ...
          >
            {occasions.map((item) => (
              ...
              >
                ...
                <p className="mt-3 font-serif text-lg text-neutral-900">
                  {item.title}
                </p>
      ...
      <Section
        id="final-cta"
        className="relative min-h-[80vh] border-t border-gray-200 bg-[#F7F6F4]"
      >
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-linear-to-b from-black/60 via-black/30 to-black/75 will-change-transform"
          />
        </div>
        <motion.div
        ...
        >
          ...
          >
            Book the entire villa for your group. Exclusive access, complete
            privacy, and memories that last.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="mx-auto grid max-w-1240px gap-8 sm:grid-cols-2 md:grid-cols-4 md:gap-10">
          <div>
            ...
            <p className="mt-3 text-sm text-neutral-600">
              Your private villa escape — for families, barkada, and special
              occasions.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-neutral-700">
              {villas.map((v) => (
                <li key={v.id}>
                  <button
                    onClick={() =>
                      onNavigate({ type: "detail", villaId: v.id })
                    }
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-neutral-700">
              We respond within the day. Message us to check your preferred
              dates.
            </p>
          </div>
        </div>
