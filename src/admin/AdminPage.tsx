    ...
    return (
      <main className="min-h-screen bg-[#F7F6F4] flex flex-col justify-center px-6 py-16 text-[#0A192F] md:px-10">
        <div className="mx-auto w-full max-w-md border border-gray-200 bg-white p-10 shadow-2xl shadow-black/5">
          ...
          <p className="text-center text-[10px] uppercase tracking-[0.2em] text-gray-500">
            Admin Portal
          </p>
          <h1 className="mt-3 text-center font-serif text-3xl text-[#0A192F]">
            Secure Access
          </h1>

          <form onSubmit={handleLogin} className="mt-10 space-y-5">
            <div>
              <label className="mb-2 block text-xs uppercase tracking-[0.15em] text-gray-600">
                Email Address
              </label>
              <input
                type="email"
          ...
          {error && (
            <p className="mt-5 border border-red-200 bg-red-50 p-3 text-center text-xs text-red-600">
              {error}
            </p>
          )}
        </div>
      ...
      <aside className="w-full md:w-64 shrink-0 border-r border-gray-200 bg-white">
        <div className="flex h-20 items-center justify-between border-b border-gray-200 px-6 md:px-8">
          ...
          <div className="md:hidden">
            <button
              onClick={() => logoutAdmin().then(() => setLoggedIn(false))}
